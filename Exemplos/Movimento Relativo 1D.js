...
function Ambiente()
{
	 ...
	 Desempenho(true, false, false);
		...
		//posicaoL = new Texto("pL="+vFL);
		//posicao = new Texto("Wallace");
...
function Simulacao()
{
	...
	//posicaoL.Texto.position.set(5,pL, 10);
		
	posicaoL.Texto2D.position.set(5, pL, 10); 
	posicaoC.Texto2D.position.set(25, pC, 10);
	posicaoM.Texto2D.position.set(45, pM, 10);	
